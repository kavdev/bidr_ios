...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSArray *keyArr = [((AuctionsPageViewController *)self.parentViewController)->completeAuctions allKeys];
    
    auction = [((AuctionsPageViewController *)self.parentViewController)->completeAuctions objectForKey:[keyArr objectAtIndex:indexPath.row]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    auction = [((AuctionsPageViewController *)self.parentViewController)->completeAuctions objectForKey:key];
